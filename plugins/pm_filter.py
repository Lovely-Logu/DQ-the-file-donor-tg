    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                text=(
                    f"<b>Hey {message.from_user.mention}, {total_results} results are found in my database "
                    f"for your query '{search}'. Kindly use inline search or make a group and add me as an admin "
                    "to get movie files. This is a support group so you can't get files from here...\n\n"
                    "For Movies, Join @Tr_Movies_Group</b>"
                ),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Tr_LinksZz_Admin_Chat_bot")
                                ]
                                ]
                            )
                        )
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ & Gʀᴏᴜᴘ ✇', callback_data='suprt_info') 
                  ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="credits"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Rolex_Logu")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
